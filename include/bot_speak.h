...
extern int botSpeak_parseConfigFrame(DataFrame_TypeDef* frame);
extern int botSpeak_parseRequestFrame(DataFrame_TypeDef* frame);
extern int botSpeak_parseResponseFrame(DataFrame_TypeDef* frame);
extern int botSpeak_parseCommandFrame(DataFrame_TypeDef* frame);
extern int botSpeak_parseEmergencyFrame(DataFrame_TypeDef* frame);
